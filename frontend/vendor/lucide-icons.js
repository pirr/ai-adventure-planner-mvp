/* Self-hosted Lucide subset — only the icons this app uses.
   Mirrors the lucide UMD API: window.lucide.createIcons({ nameAttr }).
...
(function () {
  var I = {
    ...
    "shuffle": '<path d="m18 14 4 4-4 4"/><path d="m18 2 4 4-4 4"/><path d="M2 18h1.973a4 4 0 0 0 3.3-1.7l5.454-8.6A4 4 0 0 1 16.027 6H22"/><path d="M2 6h1.972a4 4 0 0 1 3.6 2.2"/><path d="M22 18h-6.041a4 4 0 0 1-3.3-1.7l-.659-1"/>',
